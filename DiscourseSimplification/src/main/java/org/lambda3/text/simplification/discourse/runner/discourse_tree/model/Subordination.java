...
public class Subordination extends DiscourseTree {
    ...
    public Subordination(String extractionRule, Relation relation, String cuePhrase, DiscourseTree leftConstituent, DiscourseTree rightConstituent, boolean contextRight, String startText) {
    ...
    public List<String> getPTPCaption() {
        ...
        return Collections.singletonList("|||SUB/" + relation + "\t" + cuePhraseStr + "\t" + extractionRule + "\t" + startText);
    }
