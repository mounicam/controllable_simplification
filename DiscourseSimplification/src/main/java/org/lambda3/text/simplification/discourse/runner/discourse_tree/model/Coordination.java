...
public class Coordination extends DiscourseTree {
    ...
    public Coordination(String extractionRule, Relation relation, String cuePhrase, List<DiscourseTree> coordinations, String startText) {
    ...
    public List<String> getPTPCaption() {
        ...
        return Collections.singletonList("|||CO/" + relation + "\t" + cuePhraseStr + "\t" + extractionRule + "\t" + startText);
    }
